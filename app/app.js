        ...
        function ($rootScope, $window, $http, CONFIG, $localStorage) 
        {
            ...
            $rootScope.wardBed = function() {
                return [
                    ...
                    { ward: '20', bed: 2, building: { no: 6, name: 'อาคารสิรินคร', floor: 2 }, sortBy: 16 }, // เด็กวิกฤต (PICU) อาคารสิรินคร ชั้น 2
            ...
            $rootScope.covidBed = function() {
                return [
                    ...
                    { ward: '18', capacity: 15, building: { no: 4, name: 'อาคารผู้ป่วยใน', floor: 6 }, sortBy: 7 }, //ชั้น 6
